...
module.exports = {
  ...
  networks: {
    ...
    //   provider: function () {
    //     return new HDWalletProvider([privateKey], "https://mainnet.infura.io/v3/72e71a4f135741c9861fda5ad3896e57");
    //   },
    ...
    kovan: {
      ...
      provider: function () {
        return new HDWalletProvider([privateKey], "https://kovan.infura.io/v3/59eea23701b24562a3df2b752064820d");
      },
